<?php
    ...
    if (isset($_SESSION['select_memo'])) {
        ...
        $edit_title = empty($edit_memo['title']) ? "" :
        $edit_memo['title'];
        $edit_content = empty($edit_memo['content']) ? "" :
        $edit_memo['content'];
    }
            ...
            <div class="row h-100 m-0 p-0">
                <div class="col-3 h-100 m-0 p-0 border-left border-right border-gray">
                    ...
                    <div class="left-memo-list list-group-flush p-0">
                        ...
                        <a href="./action/select.php?id=<?php echo $memo['id']; ?>" class="list-group-item list-group-item-action 
                            <?php echo $edit_id == $memo['id'] ? 'active' : ''; ?>">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1"><?php echo $memo["title"] ?></h5>
                                <small><?php echo date('Y/m/d H:i',
                                strtotime($memo['updated_at'])); ?></small>
                            </div>
                            <p class="mb-1">
                                <?php
                ...
                <div class="col-9 h-100">
                    ...
                    <form class="w-100 h-100" method="post">
                        ...
                        <input type="text" id="memo-title" name="edit_title" placeholder="タイトルを⼊⼒する..." value="<?php echo $edit_title; ?>" />
                        <textarea id="memo-content" name="edit_content" placeholder="内容を⼊⼒する..."><?php echo $edit_content; ?></textarea>
                    </form>
                    <?php else: ?>
